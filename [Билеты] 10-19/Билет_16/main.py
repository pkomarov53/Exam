    ...
    if file_path:
        try:
            ...
            df = pd.DataFrame([line.strip().split(',') for line in lines],
                              columns=['дата', 'ФИО', 'вид документа', 'специальность', 'дисциплина', 'курс', 'число страниц'])
