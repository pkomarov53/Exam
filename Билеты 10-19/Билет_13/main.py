    ...
    if file_path:
        try:
            ...
            df = pd.DataFrame([line.strip().split(',') for line in lines],
                              columns=['дата', 'номер зачетки', 'ФИО', 'группа', 'МДК', 'тема'])
